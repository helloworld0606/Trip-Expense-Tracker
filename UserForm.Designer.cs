namespace Trip_Expense_Tracker
{
	partial class UserForm
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(201, 182);
			...
			// buttonCreateAC
			// 
			this.buttonCreateAC.Location = new System.Drawing.Point(249, 251);
			this.buttonCreateAC.Name = "buttonCreateAC";
			this.buttonCreateAC.Size = new System.Drawing.Size(127, 23);
			this.buttonCreateAC.TabIndex = 4;
			this.buttonCreateAC.Text = "Create Account";
			this.buttonCreateAC.UseVisualStyleBackColor = true;
			// 
			// UserForm
			// 
